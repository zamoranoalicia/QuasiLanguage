...
newtype InterpreterOutput = Environment
...
interpretProgram :: AST.Program -> (String, [[(String, Int)]])
interpretProgram (AST.Program i b) = (ST.nameFromIdentifier i, interpretBlock b ST.emptyST) -}